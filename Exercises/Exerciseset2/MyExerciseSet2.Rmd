...
* 1. We need 6 principal components to explain at least 50% of the variance
*
* 2. Highest weights is 0.93
*
* 3. Yes, they form sets of attributes which can easily be identified:
...
* 5. Futures returns per asset class look more correlated during  bull market and less correlated during bear market
*
*
